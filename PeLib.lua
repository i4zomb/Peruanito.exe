if game:GetService("CoreGui"):FindFirstChild("PeruanitoLib") then
    game:GetService("CoreGui"):FindFirstChild("PeruanitoLib"):Destroy()
end
...
local themeObjects = {}
for i, v in next, themes.Light do
    themeObjects[i] = {}
end
...
local Peruanito = utility.create("ScreenGui", {})
...
function library:Load(opts)
    ...
    local sizeX = options.sizeX or 330
    local sizeY = options.sizeY or 360
